...
setInterval(() => {
  http.get(`http://quintessential-lateral-jar.glitch.me/`); //تعديل مهم حط اسم المشروع
}, 280000);
...
const GUILDID = '1162353279276167208'; //  تعديل مهم ايدي السيرفر  
const CHANNELID = '1162353280937103404'; // تعديل مهم ايدي الروم الصوتي
